...
local GROUPS = {
    ...
    { title = "Roles & targeting", cmds = {
        { "/cz tank set <name>", "Set the Main Tank (persists across reloads)." },
        { "/cz tank automatic", "Set Main Tank to automatic resolution." },
        { "/cz tank status   (/cz tankrole)", "Print MA/MT resolution diagnostics." },
    ...
    { title = "Camp & movement", cmds = {
        ...
        { "/cz targetfilter <0|2>", "Camp mob filter: 0 = LoS NPCs (level 20+ also includes XTarget Auto-Haters), 2 = All NPCs." },
    ...
    { title = "CC / pets / cleric chain", cmds = {
        ...
        { "/cz chchain on|off|start|stop|test|delay", "Complete Heal chain (slot clock). on=participate; start from any bot arms schedules. See CH Chain tab." },
    } },

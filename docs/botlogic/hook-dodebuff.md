...
Runs the phase-first spell check for the **debuff** section. Phase order: charm, tanktar, notanktar, named. Charm recasts and charm targeting are evaluated first; then tank target, non-tank adds, and named tank target.

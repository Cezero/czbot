...
- **Camp set (fetch-return mode):** The bot finds peer corpses up to 1500 distance, runs to one, uses **/corpsedrag**, then returns to camp before looking for another corpse.

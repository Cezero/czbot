...
**GUI Advanced tab** (`/czshow` → Advanced): edit global **ma_list** and **mt_list** (MA/MT automatic fallback), and per-char **MA anchor** / **MA leash** settings. See [Automatic MA/MT Selection](automatic-ma-mt-selection.md).

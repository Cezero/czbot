...
- **CHChain:** `/cz chchain` is a separate multi-cleric Complete Heal rotation. Enable is a participate flag (normal heals continue until start). See [CHChain configuration](chchain-configuration.md).

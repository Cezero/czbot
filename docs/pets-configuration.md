...
See [Debuffing configuration](debuffing-configuration.md) for the Charm list, **recast**, and **bands** (e.g. **notmatar** for adds), and [Spell targeting and bands](spell-targeting-and-bands.md) for band and targeting logic. For mezzing in particular, see [Mezzing configuration](mezzing-configuration.md).

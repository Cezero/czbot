...
local CLASS_COL = {
  brd = 'brdlevel', ber = 'berlevel', bst = 'bstlevel', clr = 'clrlevel', dru = 'drulevel',
  enc = 'enclevel', mag = 'maglevel', mnk = 'mnklevel', nec = 'neclevel', pal = 'pallevel',
  rng = 'rnglevel', rog = 'roglevel', shd = 'shdlevel', shm = 'shmlevel', war = 'warlevel', wiz = 'wizlevel'
}
